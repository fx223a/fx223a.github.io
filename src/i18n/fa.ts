...
export default {
  ...
  home_about_text: 'ما ده سال است که در چین موتورهای موتورسیکلت تولید می‌کنیم و تجربه گسترده‌ای در طراحی و ساخت موتور داریم. از سال ۲۰۲۴ موتورهای پهپاد نیز عرضه می‌کنیم. تاکنون بیش از ۶۰٬۰۰۰ موتور تولید کرده‌ایم.', // 公司简介（客户 2026-08-08 提供）
  ...
  home_cases_title: 'مشتریان و نمونه‌کارها',                    // 客户案例（板块暂未上线，等客户后续补充资料）

  // ===== 首页：服务与保障（真实内容，来自客户报价单，价格已剔除）=====
  home_service_title: 'خدمات و پشتیبانی',
  home_service_warranty_title: 'گارانتی',
  home_service_warranty_text: '۱۲ ماه گارانتی موتور کامل؛ ۳ ماه برای قطعات مصرفی (شمع، واشر و غیره).',
  home_service_delivery_title: 'تحویل',
  home_service_delivery_text: 'مدل‌های استاندارد موجود است؛ پیکربندی‌های سفارشی در ۷ تا ۱۵ روز کاری تحویل می‌شود.',
  home_service_support_title: 'پشتیبانی فنی',
  home_service_support_text: 'پشتیبانی فنی کامل: نصب، راه‌اندازی، عیب‌یابی و آموزش نگهداری.',
  home_service_custom_title: 'سفارشی‌سازی',
  home_service_custom_text: 'سفارشی‌سازی شفت خروجی، فلنج نصب و موارد دیگر؛ نصب کششی و فشاری هر دو پشتیبانی می‌شود.',
  ...
  inquiry_intro: 'قیمت و جزئیات در گفتگو مطرح می‌شود — برای سریع‌ترین پاسخ، مستقیم در واتس‌اپ یا تلگرام پیام دهید.', // 询价页副标题（价格不放网站，客户要求）
  inquiry_whatsapp_cta: 'در واتس‌اپ با ما گفتگو کنید',          // WhatsApp 主按钮
  inquiry_or_form: 'یا فرم زیر را پر کنید — پیامی برای واتس‌اپ ما ساخته می‌شود:', // 表单引导
  form_submit_whatsapp: 'ارسال درخواست از طریق واتس‌اپ',        // 表单提交按钮（打开 WhatsApp 预填消息）
  form_whatsapp_opened: 'در حال باز کردن واتس‌اپ… اگر باز نشد، از دکمه واتس‌اپ بالا استفاده کنید.', // 提交后提示
  form_name: 'نام',                                            // 姓名
